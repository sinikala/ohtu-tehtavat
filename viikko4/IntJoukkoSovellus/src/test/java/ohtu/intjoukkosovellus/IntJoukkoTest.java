...
public class IntJoukkoTest {
    ...
    public void vainLisatytLuvutLoytyvat() {
        assertTrue(joukko.onkoJoJoukossa(10));
        assertFalse(joukko.onkoJoJoukossa(5));
        assertTrue(joukko.onkoJoJoukossa(3));
    }

    @Test
    public void poistettuEiOleEnaaJoukossa() {
        joukko.poista(3);
        assertFalse(joukko.onkoJoJoukossa(3));
    ...
    public void toimiiKasvatuksenJalkeen(){
        ...
        assertTrue(joukko.onkoJoJoukossa(11));
        joukko.poista(11);
        assertFalse(joukko.onkoJoJoukossa(11));
